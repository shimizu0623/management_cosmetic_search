    ...
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <p class="card-category">Handcrafted by our friend
          <a target="_blank" href="//github.com/mouse0270">Robert McIntosh</a>. Please checkout the
          <a href="//bootstrap-notify.remabledesigns.com/" target="_blank">full documentation.</a>
        </p>
      </div>
      <div class="card-body">
        <div class="row">
